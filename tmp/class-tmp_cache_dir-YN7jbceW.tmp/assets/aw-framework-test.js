...
define('aw-framework-test/components/render-fields', ['exports', 'ember'], function (exports, Ember) {
  ...
  exports['default'] = Ember['default'].Component.extend({
    ...
    //Added the Role "drop down" menu item data here,
    //look at a controller and to serve data from the model or server mocks
    //consider Master (role) - Detail design (other detail)
    selectedRole: null,
    roles: [{
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    var child2 = (function() {
      var child0 = (function() {
        var child0 = (function() {
          return {
            ...
            statements: [
              ["inline","input",[],["type","checkbox","checked",["subexpr","@mut",[["get","field.value",["loc",[null,[15,48],[15,59]]]]],[],[]]],["loc",[null,[15,16],[15,61]]]]
            ],
            locals: [],
            templates: []
          };
        ...
        var child1 = (function() {
          var child0 = (function() {
            return {
              ...
              statements: [
                ["inline","log",[["get","controller",["loc",[null,[18,23],[18,33]]]]],[],["loc",[null,[18,16],[18,36]]]],
                ["inline","view",["select"],["content",["subexpr","@mut",[["get","roles",["loc",[null,[20,26],[20,31]]]]],[],[]],"optionLabelPath","content.roleName","selection",["subexpr","@mut",[["get","selectedRole",["loc",[null,[22,28],[22,40]]]]],[],[]],"prompt","Select a role"],["loc",[null,[19,16],[23,42]]]]
              ],
              locals: [],
              templates: []
            };
          ...
          var child1 = (function() {
            return {
              ...
              statements: [
                ["inline","input",[],["value",["subexpr","@mut",[["get","field.value",["loc",[null,[25,30],[25,41]]]]],[],[]]],["loc",[null,[25,16],[25,43]]]]
              ],
              locals: [],
              templates: []
            };
          ...
          return {
            ...
            statements: [
              ["block","if",[["get","field.isOption",["loc",[null,[17,20],[17,34]]]]],[],0,1,["loc",[null,[17,14],[26,19]]]]
            ],
            locals: [],
            templates: [child0, child1]
          };
        ...
        return {
          ...
          statements: [
            ["block","if",[["get","field.isBoolean",["loc",[null,[14,18],[14,33]]]]],[],0,1,["loc",[null,[14,12],[27,19]]]]
          ],
          locals: [],
          templates: [child0, child1]
        };
      ...
      var child1 = (function() {
        var child0 = (function() {
          return {
            ...
            statements: [
              ["inline","if",[["get","field.value",["loc",[null,[30,21],[30,32]]]],"Yes","No"],[],["loc",[null,[30,16],[30,45]]]]
            ],
            locals: [],
            templates: []
          };
        ...
        var child1 = (function() {
          return {
            ...
            statements: [
              ["content","field.value",["loc",[null,[32,16],[32,31]]]]
            ],
            locals: [],
            templates: []
          };
        ...
        return {
          ...
          statements: [
            ["block","if",[["get","field.isBoolean",["loc",[null,[29,18],[29,33]]]]],[],0,1,["loc",[null,[29,12],[33,19]]]]
          ],
          locals: [],
          templates: [child0, child1]
        };
      ...
      return {
        ...
        statements: [
          ["inline","log",[["get","controller",["loc",[null,[10,9],[10,19]]]]],[],["loc",[null,[10,2],[10,22]]]],
          ["content","field.fieldDef.title",["loc",[null,[11,8],[11,32]]]],
          ["block","if",[["get","isEditing",["loc",[null,[13,14],[13,23]]]]],[],0,1,["loc",[null,[13,8],[34,15]]]]
        ],
        locals: ["field"],
        templates: [child0, child1]
      };
    ...
    return {
      ...
      statements: [
        ...
        ["block","each",[["get","fieldObjects",["loc",[null,[9,8],[9,20]]]]],[],2,null,["loc",[null,[9,0],[36,9]]]]
      ],
      locals: [],
...
define('aw-framework-test/tests/integration/components/render-fields-test', ['ember-qunit', 'ember'], function (ember_qunit, Ember) {
    ...
    //test when `isEditing`
    //option drop down menu is populated with data
    ember_qunit.test('it renders the value when `isEditing`', function (assert) {
        this.set('fields', createFields({
            field: 'field2'
        }));
        this.set('record', Ember['default'].Object.create({
